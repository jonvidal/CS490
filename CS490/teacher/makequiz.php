...
/*if (isset($_POST['login'])){
  if (empty($_POST['quiztitle'])){
    $errormessage = "<div class='alert alert-danger'>Please Enter A Title!</div>";
  }else{
...
if (isset($_POST['add'])){
  if (empty($_POST['quiztitle']) || empty($_POST['questionID'])){
